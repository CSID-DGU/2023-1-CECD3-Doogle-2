...
def create_WLASL_dictionary():
    ...
    with open('WLASL/I3D/preprocess/wlasl_class_list.txt') as file:
        for line in file:
...
if __name__ == '__main__':
    ...
    weights = 'WLASL/I3D/archived/asl2000/FINAL_nslt_2000_iters=5104_top1=32.48_top5=57.31_top10=66.31.pt'
    create_WLASL_dictionary()
    load_model(weights, num_classes)
    # 추가: 비디오 파일 경로
    video_path = args.video_path

    # 비디오 파일 경로를 전달하여 함수 호출
    load_rgb_frames_from_video(video_path)
